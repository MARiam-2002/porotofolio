                        ...
                        {projects.map((project, index) => (
                            ...
                            >
                                <motion.div
                                    ...
                                    className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden group cursor-pointer"
                                >
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    {project.gallery.slice(0, 2).map((image, imageIndex) => (
                                                        <motion.div
                                                            ...
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                                openGalleryModal(project, imageIndex + 1);
                                                            }}
                                                        >
                                                            <CachedImage
                                                                src={image.url}
                                            ...
                                            >
                                                ...
                                                {project.links?.find(link => link.key === 'appStore') && (
                                                    <motion.a
                                                        ...
                                                        whileHover={{ scale: 1.05 }}
                                                        whileTap={{ scale: 0.95 }}
                                                        className="inline-flex items-center px-3 py-2 bg-black text-white text-sm font-semibold rounded-lg hover:bg-gray-800 transition-all duration-300 shadow-md hover:shadow-lg"
                                                    >
                                                ...
                                                {project.links?.find(link => link.key === 'playStore') && (
                                                    <motion.a
                                                        ...
                                                        whileHover={{ scale: 1.05 }}
                                                        whileTap={{ scale: 0.95 }}
                                                        className="inline-flex items-center px-3 py-2 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 transition-all duration-300 shadow-md hover:shadow-lg"
                                                    >
                                                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
